    ...
    render() {
        return (
            <div className="col-sm-3">
                <div
                    className={"Auction card card-inverse card-primary mb-3 text-center" + (this.state.bidEffect ? ' bidEffect' : '')}>
                    ...
                    <div className="imageHolder">
                        <img className="card-img-top img-fluid" src={this.props.image} alt="Some products" style={{height:'200px'}}/>
                    </div>
                    <div className="card-block">
                        ...
                        <h5 className="card-subtitle mb-2 text-info">
